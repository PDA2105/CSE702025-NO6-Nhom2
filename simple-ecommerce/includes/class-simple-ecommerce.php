...
class Simple_Ecommerce {
    ...
    private function load_dependencies() {
        ...
        require_once SIMPLE_ECOMMERCE_DIR . 'includes/controllers/class-import-controller.php';
        ...
        // Load shortcodes
        require_once SIMPLE_ECOMMERCE_DIR . 'includes/shortcodes/class-image-slider-shortcode.php';
        // Load helpers
...
>>>>>>> 76b0bef22025c284c5c2fff027b881ee20484c4d
    ...
    public function register_assets() {
        ...
        wp_enqueue_style(
            ...
            filemtime(SIMPLE_ECOMMERCE_DIR . 'public/css/simple-ecommerce-product.css')
        );
        ...
        // Also localize for product script
        wp_localize_script(
            'simple-ecommerce-product',
            'simple_ecommerce',
            array(
      ...
      /**
     * Register traditional WordPress widgets
     */
    public function register_traditional_widgets() {
        // Widget registration will be added here when needed
    }
